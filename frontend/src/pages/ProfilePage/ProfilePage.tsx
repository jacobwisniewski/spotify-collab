...
import { navigateToLandingPage, spotifyProfileLoading, spotifyUserTopTracksLoading, timeRangeChange } from "../../state/AppAction"
...
const TIME_RANGE_OPTIONS = [
  { title: "Short Term", value: TimeRange.SHORT_TERM },
  { title: "Medium Term", value: TimeRange.MEDIUM_TERM },
  { title: "Long Term", value: TimeRange.LONG_TERM }
]
...
const ProfilePage: Page = ({ integration, state, dispatch, queryParams }) => {
  ...
  useEffect(() => {
    ...
    } else if (isSuccessfullyLoaded && extended_data) {
      dispatch(spotifyUserTopTracksLoading(spotifyId))
    }
  }, [isInitial, isSuccessfullyLoaded, spotifyId, dispatch, extended_data])
